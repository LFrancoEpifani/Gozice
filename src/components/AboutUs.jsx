...
export default function AboutUs() {
  ...
  return (
    <div>
      ...
      <section className='grid grid-cols-1 p-4 w-full lg: lg:grid-cols-2 items-center justify-center lg:auto-rows-[25rem] gap-8 mx-auto lg:p-20'>
      ...
      <img className='order-2 lg:order-none lg:w-full lg:h-full lg:object-contain' src={Mango} alt="" />
