...
export default function Home() {
  ...
  return (
    <main className='w-full h-full'>
      ...
      <div className=''>
        <img className='absolute bottom-0 right-0 w-[150px] lg:top-14 lg:w-[350px]' src={Drink} alt="" />
        <img className='absolute top-0 right-0 h-full w-[200px] lg:w-[700px] lg:h-full -z-20' src={Background} alt="" />
        <img className='absolute bottom-0 right-40 w-[150px] lg:top-28  lg:right-80 lg:w-[250px]' src={Plate} alt="" />
      </div>
