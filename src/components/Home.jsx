...
export default function Home() {
  ...
  return (
    <main className=''>
      ...
      <div className=''>
        <img className='absolute top-14 right-0 w-[350px]' src={Drink} alt="" />
        <img className='absolute top-0 right-0 w-[700px] h-screen -z-20' src={Background} alt="" />
        <img className='absolute top-28 right-80 w-[250px]' src={Plate} alt="" />
      </div>
