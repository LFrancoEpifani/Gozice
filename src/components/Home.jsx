  ...
  return (
    <main className='w-full h-screen'>
      ...
      <div className='text-center lg:text-start py-2'>
        <h2 className='my-6 text-3xl px-10 lg:text-5xl lg:w-2/5 text-[#E6328B] font-bold lg:my-6 lg:tracking-wide'>{t('title')}</h2>
      ...
      <div className=''>
        ...
        <img className='absolute -bottom-3g right-44 w-[150px] lg:top-44 lg:right-80 lg:w-[250px]' src={Plate} alt="" />
      </div>
