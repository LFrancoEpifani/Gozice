...
export default function Home() {
  ...
  return (
    <main className='w-full h-screen'>
      ...
      <div className=''>
        <img className='absolute -bottom-2 right-0 w-[145px] lg:right-0 lg:top-56 lg:w-[250px]' src={Bebida} alt="" />
        <img className='absolute -bottom-2 right-44 w-[150px] lg:top-44 lg:right-80 lg:w-[250px]' src={Plate} alt="" />
      </div>
