...
export default function Home() {
  ...
  return (
    <main className='w-full h-full'>
      ...
      <div className=''>
        <img className='absolute bottom-2 right-0 w-[145px] lg:right-0 lg:top-56 lg:w-[250px] object-contain' src={Bebida} alt="" />
        <img className='absolute bottom-2 right-44 w-[150px] lg:top-44 lg:right-56 lg:w-[240px] object-contain' src={Plate} alt="" />
        <img className='absolute -bottom-5 right-39 w-[195px] lg:top-36 lg:right-45 lg:w-[325px] object-contain rotating-image' src={Letters} alt="" />
      </div>
    </main>
  )
}
