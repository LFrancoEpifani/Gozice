...
export default function Home() {
  ...
  return (
    <main className='w-full h-screen bg-[#E6328B] bg-opacity-20 -z-20'>
      ...
      <div className=''>
        <img className='absolute bottom-6 right-10 w-[80px] lg:right-20 lg:top-72 lg:w-[170px]' src={Smile} alt="" />
        <img className='absolute bottom-10 right-56 w-[120px] lg:top-32 lg:right-80 lg:w-[200px]' src={smallAcai} alt="" />
      </div>
